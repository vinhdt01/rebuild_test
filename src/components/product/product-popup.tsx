     ...
     <div className="flex flex-col lg:flex-row w-full md:w-[650px] lg:w-[960px] mx-auto overflow-hidden">
         <div className="flex-shrink-0 flex items-center justify-center w-full lg:w-430px max-h-430px lg:max-h-full overflow-hidden bg-gray-300">
           <img
            ...
            // height={558}
            className=" lg:object-cover lg:w-full lg:h-full"
            src="https://cdn.pnj.io/images/thumbnails/485/485/detailed/148/gv0000w000521-vong-tay-vang-trang-y-18k-pnj-01.png"
            alt="zdfdsfdssffs"
            // className="lg:object-cover lg:w-full lg:h-full"
          />
        </div>
...
<Button
              ...
              <button
                onClick={navigateToCartPage}
                className="w-full mt-4 h-11 md:h-12 rounded bg-gray-100 text-heading focus:outline-none border border-gray-300 transition-colors hover:bg-gray-50 focus:bg-gray-50 text-sm xl:text-base"
              >
              Xem giỏ hàng
              </button>
            )}
