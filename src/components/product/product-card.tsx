...
const ProductCard: FC<ProductProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="https://cdn.pnj.io/images/thumbnails/300/300/detailed/147/gnxmxmw003337-nhan-nam-vang-trang-10k-dinh-da-ecz-pnj-flowrous-01.png"
          width={imgWidth}
          height={imgHeight}
          loading={imgLoading}
          quality={100}
          alt={name || "Product Image"}
          className={cn("bg-[#fff] object-cover ltr:rounded-l-md rtl:rounded-r-md", {
            "w-full rounded-md transition duration-200 ease-in group-hover:rounded-b-none":
              variant === "grid",
            "rounded-md transition duration-150 ease-linear transform group-hover:scale-105":
              variant === "gridSlim",
